...
class FirstExcersizeVC: UIViewController {
    ...
    private func checkFinish(_ marks: [Landmark]) {
        ...
        self.currentTest.wrappedValue.firstTestResult = avgtime
        self.currentTest.wrappedValue.hasDoneFirstTest = true
...
#Preview(body: {
    FirstExcersizeHVC(test: .constant(Test()))
})
